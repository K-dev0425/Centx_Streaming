<?php
	...
	*/
	...
	$content_type = (isset($argv[5])) ? $argv[5] : false;
	...
	*/
	...
	if ($renamed){
		$log->writeLine("Conversion queue","File has been moved from Temporary dir to Conversion Queue" . $temp_file . " Orig_ " . $orig_file, true);
	}else{
		$log->writeLine("Conversion queue","Some Thing Went wrong in moving the file to Conversion Queue" . $temp_file . " Orig_ " . $orig_file, true);
	}
	...
	*/
	...
	$ffmpeg->content_type = $content_type;
